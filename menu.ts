...
export const accountPagesMenu = {
	...
	cash: {
		id: 'cash',
		text: 'Cash Book Management',
		path: 'accountant/cash-book',
		icon: 'Money',
		subMenu: null,
	},
...
export const dataentryPagesMenu = {
	dashboard: {
		id: 'dashboard',
		text: 'Dashboard',
		path: 'dataentry-operater/dashboard',
		icon: 'Dashboard',
		subMenu: null,
	},
	stock: {
		...
		path: 'dataentry-operater/stock-management',
		icon: 'Article',
		subMenu: null,
	},
...
export const stockkeeperPagesMenu = {
	...
	item: {
		...
		path: 'stock-keeper/item-management',
		icon: 'AssignmentTurnedIn',
		subMenu: null,
	},
	seller: {
